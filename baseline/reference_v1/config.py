"""
Reference V1 configuration 鈥?canonical Room 30K training parameters.
...
class ReferenceV1Config:
    ...
    # === Scene ===
    scene: str = "room"
    resolution: str = "1080p"  # 1920脳1080
    repo_root: str = "C:\\Users\\36570\\3dgs-renderer-benchmark"
    ...
    # === Loss (official) ===
    lambda_dssim: float = 0.2  # loss = (1-位)L1 + 位(1-SSIM)
