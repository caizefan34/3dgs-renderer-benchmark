...
| Combine acceleration ideas from other renderers and generate new HiGS ideas | The survey covers FlashGS, Speedy-Splat, GEMM-GS, TC-GS, temporal reuse, hierarchical culling, local sorting, Tensor Cores, and compression-aware execution. Source review confirms HiGS already performs fine-tile conic overlap masking, so current work targets scheduling and dense-mask execution instead of duplicating that feature. | **All 7 HiGS variants now have garden-scene speed and quality measurements on A100-80GB (1080p): quarter-res (553 FPS, +12%), half-res (531 FPS, +8%), SH16 (510 FPS, +4%), SH32 (502 FPS, +2%), baseline (492 FPS). Quarter-res also shows surprisingly good quality (27.44 PSNR vs 25.83 baseline) due to denoising from bilinear upscale. Tile16 and temporal-cache showed negative gains.** [Detailed comparison](/docs/epic05-higs-ablation-results-2026-07-25.md) · [P99-LPT report](reports/epic05-higs-p99-lpt-2026-07-25.md) · [30 research ideas](docs/research-roadmap-2026.md#8-thirty-renderer-research-ideas) · [EPIC-05 acceptance matrix](benchmark/renderer-research-experiments.json) |
| Find the highest practical near-lossless storage compression for native PLY checkpoints | The completed comparison covers XZ, block-float, tile-codebook, Compressed PLY, SOG, SPZ (three precision points), SOGS, and FCGS. SPZ v4 8/8 is the clear near-lossless winner: **4.161 GB to 725.9 MB (5.732x)** with PSNR delta of only -0.0009 dB on truck scene. SOGS (v1.0.0) is a one-way PlayCanvas viewer codec (no decompress API). FCGS achieves 12.843x but only 2/5 scenes pass quality gate. | **SPZ 8/8 is the recommended near-lossless compression (5.732x, virtually zero quality loss).** [Full report](reports/epic05-expanded-compression-qualification-2026-07-24.md) · [FCGS report](reports/epic05-fcgs-five-scene-2026-07-24.md) · [candidate registry](benchmark/compression-candidates.json) | **SPZ 8/8 remains the near-lossless winner. FCGS offers higher compression at lower quality. SOGS is one-way only.** [Final comparison](reports/epic05-expanded-compression-qualification-2026-07-24.md) · [FCGS report](reports/epic05-fcgs-five-scene-2026-07-24.md) · [candidate registry](benchmark/compression-candidates.json) |
