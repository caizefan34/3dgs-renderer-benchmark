...
| Combine acceleration ideas from other renderers and generate new HiGS ideas | The survey covers FlashGS, Speedy-Splat, GEMM-GS, TC-GS, temporal reuse, hierarchical culling, local sorting, Tensor Cores, and compression-aware execution. Source review confirms HiGS already performs fine-tile conic overlap masking, so current work targets scheduling and dense-mask execution instead of duplicating that feature. | **Thirty ideas are registered. Two new prototypes now have complete five-scene measurements: calibrated tile selection was -0.97%; always-on longest-first P99 scheduling was -0.63% aggregate FPS and improved P99 on only 1/5 scenes. Both negative results are published; the next refinement is conditional scheduling based on tile-work dispersion.** [P99-LPT report](reports/epic05-higs-p99-lpt-2026-07-25.md) · [calibrated-selector report](reports/epic05-higs-calibrated-2026-07-24.md) · [fusion shortlist](docs/research-roadmap-2026.md#7-higs-fusion-opportunities) · [30 research ideas](docs/research-roadmap-2026.md#8-thirty-renderer-research-ideas) · [EPIC-05 acceptance matrix](benchmark/renderer-research-experiments.json) |
| Find the highest practical near-lossless storage compression for native PLY checkpoints | The completed 45-row same-checkpoint comparison covers XZ, block-float, tile-codebook, Compressed PLY, SOG, and three SPZ precision points. SPZ v4 8/8 passes every five-scene numerical and visual gate: **4.161 GB to 725.9 MB (5.732x)**. FCGS was also reproduced as a separate pretrained-codec track: **12.843x**, but only **2/5 numerical passes** at its safest tested point. | **Expanded comparison and FCGS five-scene qualification complete; SPZ 8/8 remains the strict near-lossless winner.** [Final same-checkpoint comparison](reports/epic05-expanded-compression-qualification-2026-07-24.md) · [FCGS five-scene report](reports/epic05-fcgs-five-scene-2026-07-24.md) · [visual review](reports/generated/compression-expanded-final/global-worst-visual-review.jpg) · [candidate registry](benchmark/compression-candidates.json) |
