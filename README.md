...
| Find the highest practical near-lossless storage compression for native PLY checkpoints | SPZ v4 with 8/8-bit SH is the current measured same-checkpoint recommendation: **4.161 GB to 725.9 MB (5.732x)** over five scenes, with worst deltas of **-0.01455 dB PSNR, -0.000217 SSIM, and +0.000666 LPIPS**. All five numerical gates and all 100-frame-per-scene visual audits passed. No pruning, training images, or fine-tuning were used. | **Implemented and qualified on EPIC-05.** [Full SPZ report](reports/epic05-spz-qualification-2026-07-24.md) · [compression survey](docs/research-roadmap-2026.md#9-compression-survey) · [measured artifacts](results/measured-compression/README.md) |
