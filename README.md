...
| Combine acceleration ideas from other renderers and generate new HiGS ideas | The survey covers FlashGS, Speedy-Splat, GEMM-GS, TC-GS, temporal reuse, hierarchical culling, local sorting, Tensor Cores, and compression-aware execution. The first new prototype, `gsplat_higs_calibrated`, replaces the Gaussian-count tile heuristic with first-view GPU timing of tile 8/16. The leading kernel design remains exact conic-vs-fine-tile rejection followed by a density-adaptive sparse-warp/dense-Tensor-Core blend. | **Thirty ideas are registered; the calibrated selector is implemented and its five-scene EPIC-05 run is in progress. Other new fusion kernels remain unmeasured.** [Fusion shortlist](docs/research-roadmap-2026.md#7-higs-fusion-opportunities) · [30 research ideas](docs/research-roadmap-2026.md#8-thirty-renderer-research-ideas) · [EPIC-05 acceptance matrix](benchmark/renderer-research-experiments.json) |
| Find the highest practical near-lossless storage compression for native PLY checkpoints | The completed 45-row EPIC-05 comparison covers XZ, block-float, tile-codebook, Compressed PLY, SOG, and three SPZ precision points on five scenes. SPZ v4 8/8 is the winner that passes every numerical and visual gate: **4.161 GB to 725.9 MB (5.732x)**, worst **-0.01455 dB PSNR, -0.000217 SSIM, +0.000666 LPIPS**. | **Expanded same-checkpoint comparison complete.** [Final comparison](reports/epic05-expanded-compression-qualification-2026-07-24.md) · [generated data](reports/generated/compression-expanded-final/compression-results.md) · [visual review](reports/generated/compression-expanded-final/global-worst-visual-review.jpg) · [candidate registry](benchmark/compression-candidates.json) |
