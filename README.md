...
**📖 指标速览（新手先看这个，再看下面的数据表）**

| 指标 | 全称 | 越大/小越好 | 一句话解释 |
|---|---|---|---|
| FPS | 每秒帧数 | ✅ 越大越好 | 渲染速度，相当于游戏里的“帧率” |
| PSNR | 峰值信噪比 | ✅ 越大越好 | 画面与真实场景有多接近（dB，一般 20+ 已经不错） |
| SSIM | 结构相似度 | ✅ 越大越好 | 人眼感知的相似程度（0~1，越接近 1 越好） |
| LPIPS | 感知相似度 | ❌ 越小越好 | 神经网络打分的“看起来像不像”（0~1） |
| VRAM | 显存占用 | ❌ 越小越好 | 跑该渲染器需要多少显存（MB / GB） |
...
```mermaid
flowchart LR
    A["5 个真实场景<br/>(garden · bicycle · bonsai · truck · train)"] --> B["同一台 A100 GPU<br/>同一套相机轨迹与协议"]
...
<p align="center">
  ...
  <i>Last updated: 2026-08-05 | Authority host: EPIC-05</i>
</p>
