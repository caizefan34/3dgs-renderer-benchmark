...
namespace gaussian_render_inference_scene
{
    ...
    public:
        ...
        /// Get bitmask of visible Gaussians from last render.
        /// Returns int32 tensor of shape [(N+31)/32] where bit j of word i
        /// indicates Gaussian (i*32 + j) was visible in the last render.
        at::Tensor getVisibleMask() const;
