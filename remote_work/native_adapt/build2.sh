...
/mnt/storage_pool/liaoyuanjun/higs-13scene-env/bin/python -u build.py 2>&1 | tee /mnt/storage_pool/liaoyuanjun/higs_p2_1a_build_fp32.log
echo "PIPE_STATUS=${PIPESTATUS[0]}"