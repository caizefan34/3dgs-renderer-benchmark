...
class RendererResearchExperimentsTest(unittest.TestCase):
    def test_all_ideas_have_explicit_epic05_acceptance(self):
        document = json.loads(
        ...
        self.assertEqual([row["id"] for row in experiments], list(range(1, len(experiments) + 1)))
...
if __name__ == "__main__":
    unittest.main()
'''
with open('tests/test_renderer_research_experiments.py', 'w') as f:
    f.write(content)
print('Written OK')
