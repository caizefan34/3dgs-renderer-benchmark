#!/bin/bash
# Round-63 exp3: cross-scene 3-seed validation of the projection-refresh decay lever.
#   bicycle: ctrl s0 + d0.99+proj s0/s1/s2 (GPUs 0-3)
#   train:   ctrl s0 + d0.99+proj s0/s1/s2 (GPUs 4-7)
