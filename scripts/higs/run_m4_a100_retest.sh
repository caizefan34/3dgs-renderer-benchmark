...
# train 3 seeds full vs eg r=0.35 (lambda=0.7) vs eg r=0.30; bicycle seed 0-1. Round 41b result: lambda=0.7 (uniform-mix) is the recommended operating point.
...
run_dyn () {
  local gpu=$1 scene=$2 ratio=$3 seed=$4 lam=$5 tag=$6
...
run_dyn 0 tanks_and_temples/train 1.0  0 1.0 m4_train_full_s0
run_dyn 0 tanks_and_temples/train 1.0  1 1.0 m4_train_full_s1
run_dyn 0 tanks_and_temples/train 1.0  2 1.0 m4_train_full_s2
run_dyn 0 tanks_and_temples/train 0.35 0 0.7 m4_train_eg035_l07_s0
run_dyn 0 tanks_and_temples/train 0.35 1 0.7 m4_train_eg035_l07_s1
run_dyn 0 tanks_and_temples/train 0.35 2 0.7 m4_train_eg035_l07_s2
run_dyn 0 tanks_and_temples/train 0.30 0 0.7 m4_train_eg030_l07_s0
run_dyn 0 tanks_and_temples/train 0.30 1 0.7 m4_train_eg030_l07_s1
run_dyn 0 tanks_and_temples/train 0.30 2 0.7 m4_train_eg030_l07_s2
run_dyn 0 mipnerf360/bicycle 1.0  0 1.0 m4_bicycle_full_s0
run_dyn 0 mipnerf360/bicycle 0.35 0 0.7 m4_bicycle_eg035_l07_s0
run_dyn 0 mipnerf360/bicycle 0.30 0 0.7 m4_bicycle_eg030_l07_s0
echo ALL_DONE
