#!/usr/bin/env python3
"""Standalone ncu profile target: room tile32 rasterize kernel."""
import os, sys
...
# Warmup
for _ in range(3):
    rendered, _, _ = rasterization(means=xyz, quats=quats, scales=scales, opacities=ops, colors=shs, viewmats=cam.viewmatrix.unsqueeze(0), Ks=cam.K.unsqueeze(0), width=cam.image_width, height=cam.image_height, tile_size=32, sh_degree=3, packed=True, render_mode="RGB")
