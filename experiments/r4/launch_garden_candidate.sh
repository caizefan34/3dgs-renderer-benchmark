#!/bin/bash
# Launch garden candidate_c 30K training on GPU 6
...
OUTPUT="/mnt/storage_pool/liaoyuanjun/r4_13scene_v2/garden/candidate_c"
mkdir -p "$OUTPUT"

echo "[$(date)] Starting garden candidate_c 30K training on GPU 6"
